...
from tkinter import filedialog, Label, Frame, Canvas, ttk
import cv2
import numpy as np
import threading
...
class VideoAnnotatorApp:
    def __init__(self, root):
        ...
        self.mode_dropdown = ttk.Combobox(self.control_frame, textvariable=self.mode_var, values=["Ellips", "Round", "Triangle"], state="readonly", font=("Arial", 12))
